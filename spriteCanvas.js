(function (data) {
    ...
    //存储SVG相关的信息
    var uniqueId = 0;
    st.UniqueId = function () { uniqueId++; return 'canvg' + uniqueId; };
            
    st.Definitions = {};
    st.Styles = {};
    st.StylesSpecificity = {};
    st.Animations = [];
    st.Images = [];
...
//      console.log( st.interval);
    ...
    st.initRoot = function() {
        ...
        // // st.root.setAttribute('viewBox', 0 + ' ' + 0 + ' ' + 0 + ' ' + 0);
        ...
        var root = st.root = document.createElement('canvas');
        root.width = 960;
        root.height = 540;
        st.scene = document.createElement('div');
        st.scene.style.position = 'relative';
...
//              console.log(key);
        ...
        */
        var setColor = function(path, fillObject, shapeId, colorIndex) {
            console.log("args",path,fillObject,shapeId,colorIndex);
