...
//              console.log(key);
    ...
    st.filterElement = function(g, filters) {
        console.log('filterElement filterElement filterElement');
        var maps = {
            '0' : 'Shadow',
            '1' : 'Blur',
            '2' : 'Glow',
    ...
    */
    ...
    st.sprite.prototype.moveText = function(shape, placeObject) {
        ...
        var txts = shape.children[1].children,
            mx = placeObject['ma'];
    ...
    st.sprite.prototype.colorTransform = (function() {
        ...
        */
        function cxSprite(shape, cx, spriteInstance) {
            ...
            var childs = shape.children[1].children;
        ...
        return function(shape, cx) {
            ...
            if ((type == 'shape' || type == 'text') && (shape.nodeName.toLowerCase() != 'clippath')) {
                ...
                try {
                    ...
                    //     transform(path, cx);
                    // }
                    for (var i = 0, j = rs.children.length; i < j; i++) {
                        var path = rs.children[i];
                        transform(path, cx);
                    }
...
//          console.log(this.clipDepthId);
    ...
    */
    ...
    st.start = function() {
        ...
        svg.ctxcan = showcanvas.getContext('2d');
